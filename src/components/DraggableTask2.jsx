...
import { MoreVertical, Calendar, CheckSquare, Edit2, Trash2, GripVertical, UserCheck, Clock, Paperclip, MessageCircle } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      {task.tags && task.tags.length > 0 && (
        <div className="flex flex-wrap gap-1.5 mb-2.5 ml-4">
      ...
      {/* Solicitante */}
      {task.requestedBy && (
        <div className="mb-2.5 ml-4 flex items-center space-x-1.5 text-[10px] text-neutral-500">
          ...
          <div className="flex items-center space-x-1">
            ...
            <div className="flex -space-x-2">
              {assignees.slice(0, 3).map((assignee, index) => (
                <div
                  key={index}
                  className="w-6 h-6 bg-gradient-to-br from-primary-600 to-primary-700 rounded-full flex items-center justify-center shadow-sm border-2 border-white"
                  title={assignee}
                >
